						...
						juce::MouseListener
{
	...
	//juce::Array<float> lowWaveTable, midWaveTable, highWaveTable;
...
private:
	...
	float fadeMax = 1.f;
	float fadeMin = 0.0f;
	float fadeStepUp = 0.1f;
	float fadeStepDown = 0.1f;
	...
	float fadeMinCursor = 0.65;
	float fadeStepUpCursor = 0.1f;
	float fadeStepDownCursor = 0.1f;
